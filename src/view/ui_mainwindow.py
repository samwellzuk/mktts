...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.autoplayBox = QtWidgets.QCheckBox(self.groupBox_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.autoplayBox.sizePolicy().hasHeightForWidth())
        self.autoplayBox.setSizePolicy(sizePolicy)
        self.autoplayBox.setObjectName("autoplayBox")
        self.verticalLayout_3.addWidget(self.autoplayBox)
